...
class _CompteState extends State<Compte> {
  ...
  Widget _buildModificationNom(nom) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: !widget.trade ? 'Nom' : 'Last name',
  ...
  Widget _buildModificationPrenom(prenom) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: !widget.trade ? 'Prénom' : 'First name',
        border: OutlineInputBorder(
          borderRadius: const BorderRadius.all(Radius.circular(15.0)),
          gapPadding: 20,
        ),
  ...
  Widget _buildModificationDate(date) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        labelText: !widget.trade ? 'Date de naissance' : 'Date of birth',
        labelStyle: TextStyle(
            color: Color.fromRGBO(209, 62, 150, 1), fontFamily: 'myriad'),
        contentPadding: EdgeInsets.all(14.0),
        prefixIcon: Icon(
  ...
  Widget _buildModificationPhone(phone) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        labelText: !widget.trade ? 'Numéro de téléphone' : 'Phone number',
        labelStyle: TextStyle(
            color: Color.fromRGBO(209, 62, 150, 1), fontFamily: 'myriad'),
        contentPadding: EdgeInsets.all(14.0),
        prefixIcon: Icon(
    ...
    return TextButton(
      onPressed: () {
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  PasswordScreen(user: widget.user, trade: widget.trade)),
        );
      },
      child: !widget.trade
          ? Text(
