...
class SignScreen extends StatefulWidget {
  ...
  bool trade;
  SignScreen({Key key, this.trade}) : super(key: key);
  @override
...
class SignScreenState extends State<SignScreen> {
  ...
  Widget _buildConfirmPasswordTF() {
    return Column(
      ...
      children: <Widget>[
        Text(
          !widget.trade ? 'Confirmer votre Mot de Passe' : 'Confirm your password',
          style: kLabelStyle,
        ),
        SizedBox(height: 10.0),
        Center(
          ...
          onPressed: () {
            if (_formKey.currentState.validate()) {
              ...
              Navigator.pushNamed(
                context,
                '/SignConfirm.dart',
                arguments: ScreenArgument(_email, _password, widget.trade),
              );
            }
          }),
    );
  ...
  Widget _buildLoginBtn() {
    return GestureDetector(
        child: RichText(
          text: TextSpan(
            children: [
              TextSpan(
                text:
                    !widget.trade ? "Vous avez un compte? \n" : "you have an account \n",
                style: TextStyle(
                  fontFamily: 'Myriade',
                  color: Color.fromRGBO(209, 62, 150, 1),
                  fontSize: 18.0,
              ...
              TextSpan(
                text: !widget.trade ? 'Connectez-vous' : 'Log in',
                style: TextStyle(
                  fontFamily: 'Myriade',
                  color: Color.fromRGBO(209, 62, 150, 1),
                  fontSize: 18.0,
        ...
        onTap: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => LoginScreen(trade: widget.trade,)),
          );
        });
  }
              ...
              Center(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        !widget.trade ? 'Inscription' : 'Sign up',
                        style: TextStyle(
                          color: Color.fromRGBO(209, 62, 150, 1),
                          fontFamily: 'Myriade',
                          fontSize: 30.0,
