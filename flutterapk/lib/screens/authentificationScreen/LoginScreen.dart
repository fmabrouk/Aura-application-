...
class LoginScreen extends StatefulWidget {
  ...
  bool trade;
  LoginScreen({Key key, this.trade}) : super(key: key);
  @override
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget _buildPasswordTF() {
    return Column(
      ...
      children: <Widget>[
        Text(
          !widget.trade ? 'Mot de Passe' : 'Password',
          style: kLabelStyle,
        ),
        SizedBox(height: 10.0),
        Center(
  ...
  Widget _buildForgotPasswordBtn() {
    return Container(
      ...
      child: TextButton(
        ...
        child: Text(
          !widget.trade ? 'Mot de passe oublié?' : 'Forgot Password?',
          style: kLabelStyle,
        ),
      ),
    );
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          ...
          Text(
            !widget.trade ? 'Se souvenir de moi' : 'Remember me',
            style: kLabelStyle,
          ),
        ],
      ),
  ...
  Widget _buildLoginBtn() {
    return Container(
      ...
      child: ElevatedButton(
          ...
          child: Text(
            !widget.trade ? 'SE CONNECTER' : 'LOG IN',
            style: TextStyle(
              color: Color.fromRGBO(209, 62, 150, 1),
              letterSpacing: 1.5,
              fontSize: 18.0,
    ...
    return GestureDetector(
        child: RichText(
          text: TextSpan(
            children: [
              ...
              TextSpan(
                text: !widget.trade ? 'Inscrivez-vous' : 'Create new account',
                style: TextStyle(
                  color: Color.fromRGBO(209, 62, 150, 1),
                  fontFamily: 'myriad',
                  fontSize: 18.0,
        ...
        onTap: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => SignScreen(trade: widget.trade)),
          );
        });
  }
  ...
  Widget build(BuildContext context) {
    if (widget.trade == null) widget.trade = false;
    return Scaffold(
      key: scaffoldKey,
      appBar: AppBar(
        elevation: 0,
