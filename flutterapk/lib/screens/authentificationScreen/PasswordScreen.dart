...
class PasswordScreen extends StatefulWidget {
  ...
  PasswordScreen({this.user, this.trade});
...
class _PasswordScreenState extends State<PasswordScreen> {
  ...
  Widget _buildModificationPasswordActuel(String password) {
    return TextFormField(
      ...
      validator: (input) =>
          (input != password) ? !widget.trade?'Le mot de passe est incorrect ':'The password is incorrect' : null,
      ...
      decoration: InputDecoration(
        ...
        labelText: !widget.trade?'Mot de passe actuel':'Current password',
  ...
  Widget _buildModificationPasswordNouveau(String password) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        labelText: !widget.trade?'Nouveau mot de passe':'New password',
        labelStyle: TextStyle(
          color: Color.fromRGBO(209, 62, 150, 1),
          fontFamily: 'myriad',
        ),
  ...
  Widget _buildModificationPasswordConfirm() {
    return TextFormField(
      obscureText: _isSecret,
      validator: (input) =>
          input != myController.text ? !widget.trade?'Mot de passe incorrect':'Incorrect password' : null,
      ...
      decoration: InputDecoration(
        ...
        labelText: !widget.trade?'Retapez le nouveau mot de passe':'Reenter your password',
        labelStyle: TextStyle(
            color: Color.fromRGBO(209, 62, 150, 1), fontFamily: 'myriad'),
        hintText: '......',
                    ...
                    if (snapshot.hasData) {
                      ...
                      return Expanded(
                        child: ListView(
                          ...
                          children: [
                            SizedBox(height: 10),
                            !widget.trade? _buildText('Modifier mon mot de passe'):_buildText('Change my password'),
                            SizedBox(height: 60),
                            Form(
                              key: _formKey1,
                              child: Column(
